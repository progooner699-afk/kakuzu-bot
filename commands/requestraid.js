...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const rules = [
            ...
            '- ✅ Server Sniped: A rival clan intentionally joined your server specifically to target and clear your members.',
            ...
            '',
            '🗑️ Quick Reminder',
            'Always provide accurate enemy names and enemy clan info so helpers know exactly what loadout or strategy to bring!',
            '```',
            '',
