...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setTimestamp()
            .addFields([
                { name: 'Raid Alert Channels', value: 'Temporary `raid-alert-<id>` channels are auto-created in the Raid Result Channel\'s category and deleted 1 minute after the raid closes (alerts posted via the `backupalerts` webhook).', inline: false },
